...
setproctitle('(janghoon) e-commerce_final please don\'t')
...
def main():
    ...
    parser.add_argument("--train_file",
                        default="e_commerce_post_train.pkl",
                        type=str,
    ...
    #model.bert.load_state_dict(state_dict=torch.load("e-commerce_final/checkpoint35-193695/bert.pt"))
    model.to(device)
    ...
    if args.do_train:
        ...
        for epoch in trange(1, int(args.num_train_epochs) + 1, desc="Epoch"):
            ...
            if True:
                ...
                checkpoint_prefix = 'checkpoint' + str(epoch+35)
